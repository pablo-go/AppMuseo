		...
		buildplaypause: function(player, controls, layers, media) {
			var 
				...
				$('<div class="mejs-button mejs-playpause-button mejs-play" >' +
					'<button onclick="" type="button" aria-controls="' + t.id + '" title="' + t.options.playpauseText + '"></button>' +
				'</div><div class="numero-audio">0</div>')
				.appendTo(controls)
				.click(function(e) {
					e.preventDefault();
	...
	$.extend(MediaElementPlayer.prototype, {
		buildprogress: function(player, controls, layers, media) {
			...
			$('<div class="mejs-time-rail">'+
				'<span class="titulo-rail">Titulo</span>'+
	...
	$.extend(MediaElementPlayer.prototype, {
		buildcurrent: function(player, controls, layers, media) {
			...
			$('<div class="mejs-time">'+
					...
					'<span class="mejs-separator-container">/</span></div>')
					.appendTo(controls);
